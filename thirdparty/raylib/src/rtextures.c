...
void DrawTextureRec(Texture2D texture, rl_Rectangle source, Vector2 position, Color tint)
{
...
void DrawTexturePro(Texture2D texture, rl_Rectangle source, rl_Rectangle dest, Vector2 origin, float rotation, Color tint)
{
...
void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, rl_Rectangle dest, Vector2 origin, float rotation, Color tint)
{
    if (texture.id > 0)
    {
        float width = (float)texture.width;
